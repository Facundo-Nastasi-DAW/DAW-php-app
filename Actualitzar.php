...
class Actualitzar {
     ...
     * Este método recibe los datos actualizados de un producto y los guarda en la base de datos.
     * 
     ...
     * @return bool Retorna true si la actualización se ha realizado correctamente, false en caso contrario.
    */
